            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ url('admin/base') }}" method="POST">
                        ...
                        <input type="radio" name="set_info_state" class="" value="0" checked>图文内容
                        <input type="radio" name="set_info_state" class="" value="1">新闻列表
                        <input type="radio" name="set_info_state" class="" value="2">图片列表
                        <input type="radio" name="set_info_state" class="" value="3">图文列表
                        <br>
